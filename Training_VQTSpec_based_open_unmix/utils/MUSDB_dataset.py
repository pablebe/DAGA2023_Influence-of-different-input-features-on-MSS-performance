...
#        source_augmentations: Optional[Callable] = lambda audio: audio,
        source_augmentations: bool=True,
        ...
        **kwargs,
        ...
        # if not(download):
        #     # if tracks are stored loacally load all tracks of dataset! 
        #     self.mus.load_mus_tracks()
        ...
        if self.seq_duration:
            for k, source in enumerate(self.mus.setup["sources"]):
                ...
                if self.source_augmentations:
                    audio = augment_force_stereo(audio)
                    audio = augment_gain(audio)
                    audio = augment_channelswap(audio)
