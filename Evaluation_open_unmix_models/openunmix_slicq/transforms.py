...
from .nsgt_mod import NSGT_sliced, BarkScale, MelScale, LogScale, VQLogScale, OctScale
...
class NSGTBase(nn.Module):
    def __init__(self, scale, fbins, fmin, fmax, fs=44100, device="cuda", gamma=25., matrixform=False, sllen=None, trlen=None):
